...
namespace Proje.UI.Areas.Admin.Controllers
{
    ...
    public class CategoryController : BaseController
    {
        ...
        {
            //Aynı isimde bir kategori oluşturulamasın
        ...
        {
            //Soru işareti ile boş geçilebilir yapıyoruz ve id olmadan yani direk update sayfası açılarak istek gönderilirse, direk list metoduna yönlendiriyoruz.
